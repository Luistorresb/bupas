...
import { AppHeaders } from '../interfaces/generic.interface';
...
export class StorageService {
  ...
  get headers(): HttpHeaders {
    let _appHeaders: AppHeaders | any = {
      'Content-Type': 'application/json',
      idplataforma: '3',
      imei: this.imei,
      uid: 'this.uid',
      'woo-token': 'this.token',
      'wo-public-key': _appKey_,
    } as AppHeaders;
    // console.log(_appHeaders);
    return new HttpHeaders(_appHeaders);
  }
